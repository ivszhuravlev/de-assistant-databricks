...
def test_verify_score_fails_on_unscored_holes():
    from verify_score import collect_failures, expected_match
...
def test_verify_score_passes_complete_first_run():
    from verify_score import EXPECTED_COUNTS, collect_failures, expected_match
